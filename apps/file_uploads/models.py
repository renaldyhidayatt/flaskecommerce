...
class FileUpload(db.Model):
    ...
    __mapper_args__ = {"polymorphic_on": type, "polymorphic_identity": "FileUpload"}
...
class TagImage(FileUpload):
    ...
    __mapper_args__ = {"polymorphic_identity": "TagImage"}
...
class ProductImage(FileUpload):
    ...
    __mapper_args__ = {"polymorphic_identity": "ProductImage"}
...
class CategoryImage(FileUpload):
    ...
    __mapper_args__ = {"polymorphic_identity": "CategoryImage"}
